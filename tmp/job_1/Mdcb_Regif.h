...
#define MY_REG_ENCODER_ZEROSINGLE  = 0xc
#define MY_REG_ENCODER1_POS        = 0x10
#define MY_REG_ENCODER2_POS        = 0x14
#define MY_REG_ENCODER3_POS        = 0x18
#define MY_REG_ENCODER4_POS        = 0x1c
#define MY_REG_ENCODER_POS_CLR     = 0x20
#define MY_REG_ENCODER1_LOCK_POS   = 0x24
#define MY_REG_ENCODER2_LOCK_POS   = 0x28
#define MY_REG_ENCODER3_LOCK_POS   = 0x2c
#define MY_REG_ENCODER4_LOCK_POS   = 0x30
#define MY_REG_RESERVE1            = 0x34
#define MY_REG_RESERVE2            = 0x38
#define MY_REG_RESERVE3            = 0x3c
#define MY_REG_RESERVE4            = 0x40
#define MY_REG_BISSC1_POS          = 0x44
#define MY_REG_BISSC2_POS          = 0x48
#define MY_REG_BISSC3_POS          = 0x4c
#define MY_REG_BISSC4_POS          = 0x50
#define MY_REG_TTL_SINGLE          = 0x54
#define MY_REG_OPT_SINGLE          = 0x58
#define MY_REG_RESERVE5            = 0x5c
#define MY_REG_RESERVE6            = 0x60
#define MY_REG_RESERVE7            = 0x64
#define MY_REG_RESERVE8            = 0x68
#define MY_REG_AD7606_DATATEMP12   = 0x6c
#define MY_REG_AD7606_DATATEMP34   = 0x70
#define MY_REG_AD7606_DATATEMP56   = 0x74
#define MY_REG_AD7606_DATATEMP78   = 0x78
#define MY_REG_AD7606_DATATEMP910  = 0x7c
#define MY_REG_AD7606_DATATEMP1112 = 0x80
#define MY_REG_AD7606_DATATEMP1314 = 0x84
#define MY_REG_AD7606_DATATEMP1516 = 0x88
#define MY_REG_RESERVE9            = 0x8c
#define MY_REG_RESERVE10           = 0x90
#define MY_REG_RESERVE11           = 0x94
#define MY_REG_RESERVE12           = 0x98
#define MY_REG_AD5544_DATATEMP12   = 0x9c
#define MY_REG_AD5544_DATATEMP34   = 0xa0
#define MY_REG_AD5544_DATATEMP56   = 0xa4
#define MY_REG_AD5544_DATATEMP78   = 0xa8
#define MY_REG_AD5544_DATATEMP910  = 0xac
#define MY_REG_AD5544_DATATEMP1112 = 0xb0
#define MY_REG_M_EN_TTL            = 0xb4
#define MY_REG_FPGA_DO             = 0xb8
...
typedef union{
    ...
    struct{
        ...
        uint32_t na_______:3;
        uint32_t TTL8_Single:1;
        uint32_t na________:3;
    } reg;
} my_reg_ttl_single_t
