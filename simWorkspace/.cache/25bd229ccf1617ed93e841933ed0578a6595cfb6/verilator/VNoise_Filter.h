...
VL_MODULE(VNoise_Filter) {
  public:
    ...
    CData/*0:0*/ Noise_Filter__DOT__temp;
    ...
    static CData/*3:0*/ __Vtable1_Noise_Filter__DOT__data_delayed[128];
    static CData/*0:0*/ __Vtable1_Noise_Filter__DOT__temp[128];
  ...
  public:
    ...
    static void _sequent__TOP__1(VNoise_Filter__Syms* __restrict vlSymsp);
    static void _settle__TOP__2(VNoise_Filter__Syms* __restrict vlSymsp) VL_ATTR_COLD;
