...
VL_MODULE(VX300_SDAC_TOP) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ X300_SDAC_TOP__DOT__sdac_area_tick_counter_willIncrement;
        CData/*7:0*/ X300_SDAC_TOP__DOT__sdac_area_tick_counter_valueNext;
        CData/*7:0*/ X300_SDAC_TOP__DOT__sdac_area_tick_counter_value;
        CData/*0:0*/ X300_SDAC_TOP__DOT__sdac_area_tick_counter_willOverflow;
  ...
  public:
    static void _combo__TOP__19(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
    static void _combo__TOP__21(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
    static void _combo__TOP__7(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__11(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
    static void _sequent__TOP__12(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
    static void _sequent__TOP__14(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
    static void _sequent__TOP__15(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
    static void _sequent__TOP__17(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
    ...
    static void _sequent__TOP__4(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
