...
VL_MODULE(VFiberTxBuffer) {
  ...
  public:
    static void _combo__TOP__10(VFiberTxBuffer__Syms* __restrict vlSymsp);
    static void _combo__TOP__7(VFiberTxBuffer__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__9(VFiberTxBuffer__Syms* __restrict vlSymsp);
    static void _settle__TOP__6(VFiberTxBuffer__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void traceChgThis__13(VFiberTxBuffer__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
