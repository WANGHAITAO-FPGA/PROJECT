...
VL_MODULE(VTop_Module_Test) {
  public:
    ...
    struct {
        ...
        CData/*4:0*/ Top_Module_Test__DOT__gssl_area_gssl_module__DOT__gssl_txarea_cyp1401_init__DOT__GSSL_Reset_Counter;
    ...
    CData/*4:0*/ __Vdly__Top_Module_Test__DOT__gssl_area_gssl_module__DOT__gssl_txarea_cyp1401_init__DOT__GSSL_Reset_Counter;
