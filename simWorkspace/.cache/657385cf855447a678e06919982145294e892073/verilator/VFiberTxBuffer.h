...
VL_MODULE(VFiberTxBuffer) {
  ...
  public:
    static void _combo__TOP__13(VFiberTxBuffer__Syms* __restrict vlSymsp);
  ...
  public:
    ...
    static void _multiclk__TOP__12(VFiberTxBuffer__Syms* __restrict vlSymsp);
    static void _sequent__TOP__10(VFiberTxBuffer__Syms* __restrict vlSymsp);
    static void _sequent__TOP__11(VFiberTxBuffer__Syms* __restrict vlSymsp);
