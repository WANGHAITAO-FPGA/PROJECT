...
VL_MODULE(VGTP_TEST) {
  public:
    ...
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo_io_pop_valid;
    ...
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT___zz_1;
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_pushPtr_willIncrement;
    CData/*6:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_pushPtr_valueNext;
    CData/*6:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_pushPtr_value;
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_popPtr_willIncrement;
    CData/*6:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_popPtr_valueNext;
    CData/*6:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_popPtr_value;
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_ptrMatch;
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_risingOccupancy;
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_pushing;
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_popping;
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_full;
    CData/*0:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT___zz_io_pop_valid;
    ...
    IData/*31:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT___zz_logic_ram_port0;
    IData/*31:0*/ GTP_TEST__DOT__gtx_area_mem[256];
    IData/*31:0*/ GTP_TEST__DOT__gtx_area_streamfifo__DOT__logic_ram[128];
