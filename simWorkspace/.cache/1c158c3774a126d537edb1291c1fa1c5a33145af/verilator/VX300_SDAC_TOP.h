...
VL_MODULE(VX300_SDAC_TOP) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ X300_SDAC_TOP__DOT__sdac_area_ledtemp;
        CData/*0:0*/ X300_SDAC_TOP__DOT__sdac_area_counter_willClear;
        CData/*0:0*/ X300_SDAC_TOP__DOT__sdac_area_tx_tick;
        CData/*0:0*/ X300_SDAC_TOP__DOT__sdac_area_tick_count_willIncrement;
        CData/*0:0*/ X300_SDAC_TOP__DOT__sdac_area_tick_count_willClear;
    ...
    struct {
        ...
        SData/*15:0*/ X300_SDAC_TOP__DOT__sdac_area_tick_count_valueNext;
        SData/*15:0*/ X300_SDAC_TOP__DOT__sdac_area_tick_count_value;
        ...
        IData/*25:0*/ X300_SDAC_TOP__DOT__sdac_area_counter_valueNext;
        IData/*25:0*/ X300_SDAC_TOP__DOT__sdac_area_counter_value;
    ...
    CData/*0:0*/ __Vdly__X300_SDAC_TOP__DOT__sdac_area_ledtemp;
  ...
  public:
    ...
    static void _combo__TOP__2(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__3(VX300_SDAC_TOP__Syms* __restrict vlSymsp);
