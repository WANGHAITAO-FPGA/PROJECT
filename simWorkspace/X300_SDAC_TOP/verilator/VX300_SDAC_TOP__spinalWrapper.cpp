...
#endif
#include "VX300_SDAC_TOP__Syms.h"
...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.intput_valid );
      signalAccess[1] = new CDataSignalAccess( top.intput_ready );
      signalAccess[2] = new CDataSignalAccess( top.intput_payload_last );
      signalAccess[3] = new IDataSignalAccess( top.intput_payload_fragment );
      signalAccess[4] = new CDataSignalAccess( top.output_valid );
      signalAccess[5] = new CDataSignalAccess( top.output_ready );
      signalAccess[6] = new CDataSignalAccess( top.output_payload_last );
      signalAccess[7] = new IDataSignalAccess( top.output_payload_fragment );
      signalAccess[8] = new CDataSignalAccess( top.AD7606_0_ad_os );
      signalAccess[9] = new CDataSignalAccess( top.AD7606_0_ad_cs );
      signalAccess[10] = new CDataSignalAccess( top.AD7606_0_ad_rd );
      signalAccess[11] = new CDataSignalAccess( top.AD7606_0_ad_reset );
      signalAccess[12] = new CDataSignalAccess( top.AD7606_0_ad_convsta );
      signalAccess[13] = new CDataSignalAccess( top.AD7606_0_ad_convstb );
      signalAccess[14] = new CDataSignalAccess( top.AD7606_0_ad_range );
      signalAccess[15] = new SDataSignalAccess( top.AD7606_0_ad_data );
      signalAccess[16] = new CDataSignalAccess( top.AD7606_0_ad_busy );
      signalAccess[17] = new CDataSignalAccess( top.AD7606_0_first_data );
      signalAccess[18] = new CDataSignalAccess( top.AD7606_1_ad_os );
      signalAccess[19] = new CDataSignalAccess( top.AD7606_1_ad_cs );
      signalAccess[20] = new CDataSignalAccess( top.AD7606_1_ad_rd );
      signalAccess[21] = new CDataSignalAccess( top.AD7606_1_ad_reset );
      signalAccess[22] = new CDataSignalAccess( top.AD7606_1_ad_convsta );
      signalAccess[23] = new CDataSignalAccess( top.AD7606_1_ad_convstb );
      signalAccess[24] = new CDataSignalAccess( top.AD7606_1_ad_range );
      signalAccess[25] = new SDataSignalAccess( top.AD7606_1_ad_data );
      signalAccess[26] = new CDataSignalAccess( top.AD7606_1_ad_busy );
      signalAccess[27] = new CDataSignalAccess( top.AD7606_1_first_data );
      signalAccess[28] = new CDataSignalAccess( top.AD7606_2_ad_os );
      signalAccess[29] = new CDataSignalAccess( top.AD7606_2_ad_cs );
      signalAccess[30] = new CDataSignalAccess( top.AD7606_2_ad_rd );
      signalAccess[31] = new CDataSignalAccess( top.AD7606_2_ad_reset );
      signalAccess[32] = new CDataSignalAccess( top.AD7606_2_ad_convsta );
      signalAccess[33] = new CDataSignalAccess( top.AD7606_2_ad_convstb );
      signalAccess[34] = new CDataSignalAccess( top.AD7606_2_ad_range );
      signalAccess[35] = new SDataSignalAccess( top.AD7606_2_ad_data );
      signalAccess[36] = new CDataSignalAccess( top.AD7606_2_ad_busy );
      signalAccess[37] = new CDataSignalAccess( top.AD7606_2_first_data );
      signalAccess[38] = new CDataSignalAccess( top.clk );
      signalAccess[39] = new CDataSignalAccess( top.reset );
      signalAccess[40] = new CDataSignalAccess( top.clk_80M );
      signalAccess[41] = new IDataSignalAccess( top.slaveid );
      signalAccess[42] = new CDataSignalAccess( top.tick );
      signalAccess[43] = new CDataSignalAccess( top.led );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\SCALA\\SRIO\\.\\simWorkspace\\X300_SDAC_TOP/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\SCALA\\SRIO\\.\\simWorkspace\\X300_SDAC_TOP/") + name + ".dat").c_str());
      #endif
    }
