...
case class Sdac_Regif(addrwidth : Int, datawidth : Int, endat_num : Int, ad7606_num : Int, bissc_num : Int, endcoder_num : Int) extends Component{
  val io = new Bundle{
  ...
  val My_Reg_Encoder1_Pos = busslave.newReg(doc="Encoder1增量式光栅尺位置信号")
  val Encoder1_Pos = My_Reg_Encoder1_Pos.field(32 bits,RO,0,"Encoder1增量式光栅尺位置信号")
  Encoder1_Pos := io.Encoder_Pos(0)

  val My_Reg_Encoder2_Pos = busslave.newReg(doc="Encoder2增量式光栅尺位置信号")
  val Encoder2_Pos = My_Reg_Encoder2_Pos.field(32 bits,RO,0,"Encoder2增量式光栅尺位置信号")
  ...
  val BissC1_Pos = My_Reg_BissC1_Pos.field(32 bits,RO,0,"BissC1绝对式光栅尺位置信号")
  BissC1_Pos := io.BissC_Pos(0)

  val My_Reg_BissC2_Pos = busslave.newReg(doc="BissC2绝对式光栅尺位置信号")
  val BissC2_Pos = My_Reg_BissC2_Pos.field(32 bits,RO,0,"BissC2绝对式光栅尺位置信号")
  BissC2_Pos := io.BissC_Pos(1)

  val My_Reg_BissC3_Pos = busslave.newReg(doc="BissC3绝对式光栅尺位置信号")
  val BissC3_Pos = My_Reg_BissC3_Pos.field(32 bits,RO,0,"BissC3绝对式光栅尺位置信号")
  BissC3_Pos := io.BissC_Pos(2)

  val My_Reg_BissC4_Pos = busslave.newReg(doc="BissC4绝对式光栅尺位置信号")
  val BissC4_Pos = My_Reg_BissC4_Pos.field(32 bits,RO,0,"BissC4绝对式光栅尺位置信号")
  ...
  val Reserve5 = My_Reg_Reserve5.field(32 bits,RW,0x01,"Reserve")
  val My_Reg_Reserve6 = busslave.newReg(doc="Reserve")
  val Reserve6 = My_Reg_Reserve6.field(32 bits,RW,0x02,"Reserve")
  val My_Reg_Reserve7 = busslave.newReg(doc="Reserve")
  val Reserve7 = My_Reg_Reserve7.field(32 bits,RW,0x03,"Reserve")
  val My_Reg_Reserve8 = busslave.newReg(doc="Reserve")
  val Reserve8 = My_Reg_Reserve8.field(32 bits,RW,0x04,"Reserve")

  val My_Reg_AD7606_Datatemp12 = busslave.newReg(doc="AD7606数据输入（U6）")
  val AD7606_Datatemp1 = My_Reg_AD7606_Datatemp12.fieldAt(0,bc = 16 bits,RO,0,"AD7606（U6）数据通道1输入")
  AD7606_Datatemp1 := io.AD7606_DATA(0)(0)
  val AD7606_Datatemp2 = My_Reg_AD7606_Datatemp12.fieldAt(16,bc = 16 bits,RO,0,"AD7606（U6）数据通道2输入")
  ...
  val My_Reg_Reserve9 = busslave.newReg(doc="Reserve")
  val Reserve9 = My_Reg_Reserve9.field(32 bits,RW,0x01,"Reserve")
  val My_Reg_Reserve10 = busslave.newReg(doc="Reserve")
  val Reserve10 = My_Reg_Reserve10.field(32 bits,RW,0x02,"Reserve")
  val My_Reg_Reserve11 = busslave.newReg(doc="Reserve")
  val Reserve11 = My_Reg_Reserve11.field(32 bits,RW,0x03,"Reserve")
  val My_Reg_Reserve12 = busslave.newReg(doc="Reserve")
  val Reserve12 = My_Reg_Reserve12.field(32 bits,RW,0x04,"Reserve")
