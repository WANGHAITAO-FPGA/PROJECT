...
case class Sdac_Regif(addrwidth : Int, datawidth : Int, endat_num : Int, ad7606_num : Int, bissc_num : Int, endcoder_num : Int, uartreg_num : Int, ad5544_num : Int) extends Component{
  val io = new Bundle{
