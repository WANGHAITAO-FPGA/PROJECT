...
case class Stcs_Mdcb_Regif(addrwidth : Int, datawidth : Int, ad5544_num : Int, ad7606_num : Int, bissc_num : Int, endcoder_num : Int) extends Component{
  val io = new Bundle{
  ...
  val M_EN_TTL5 = My_Reg_M_EN_TTL.fieldAt(18,bc = 1 bits,RW,0,"外部TTL4输出信号，M_EN_TTL4，Y2电机使能")
  io.M_EN_TTL(4) := M_EN_TTL5.asBool
  val M_EN_TTL6 = My_Reg_M_EN_TTL.fieldAt(22,bc = 1 bits,RW,0,"外部TTL4输出信号，M_EN_TTL4，Y2电机使能")
