...
case class Stcs_Sdac(addrwidth : Int, datawidth : Int, timerl_imit: Int, start_addr : Int, data_length : Int, endat_num : Int, ad7606_num : Int, ssi_num : Int, endcoder_num : Int,  uartreg_num : Int, ad5544_num : Int) extends Component{
  val io = new Bundle{
